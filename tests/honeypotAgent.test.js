...
test("detectScamType identifies lottery-prize scam text", () => {
...
test("extractIntelligence captures phone, UPI, and link", () => {
  const agent = new AdaptiveHoneypotAgent("sk-test");
  const message =
    "Call +91-9876543210 and pay to claim.prize@upi. Use https://fake-prize-site.com/claim.";
